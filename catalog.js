...
const products = [
  { id: "report:the-empty-ward", kind: "report", title: "The Empty Ward", slug: "the-empty-ward", amount: 699, sector: "Health · Bihar", cover: "/assets/covers/the-empty-ward.png", articleUrl: "https://thepublicledgerforpublic.substack.com/p/the-empty-ward-163", description: "Rs 21,743 crore of the health budget was unspent; staffing and 24×7 facility availability were weaker still." },
  ...
  { id: "report:houses-on-paper", kind: "report", title: "Houses on Paper", slug: "houses-on-paper", amount: 699, sector: "Rural development · Bihar", cover: "/assets/covers/houses-on-paper.png", articleUrl: "https://thepublicledgerforpublic.substack.com/p/houses-on-paper-879", description: "Reported completion did not consistently mean a finished, usable home on the ground." },
  { id: "report:the-price-with-no-proof", kind: "report", title: "The Price With No Proof", slug: "the-price-with-no-proof", amount: 699, sector: "Agriculture · National", cover: "/assets/covers/the-price-with-no-proof.png", articleUrl: "https://thepublicledgerforpublic.substack.com/p/the-price-with-no-proof-b33", description: "What happens after paddy is procured at the support price? The records leave a costly gap." },
  ...
  { id: "report:the-last-tiger", kind: "report", title: "The Last Tiger", slug: "the-last-tiger", amount: 699, sector: "Wildlife · Jharkhand", cover: "/assets/covers/the-last-tiger.png", articleUrl: "https://thepublicledgerforpublic.substack.com/p/the-last-tiger-63c", description: "A conservation promise carried by too little staff, too-late planning and unresolved community rights." },
